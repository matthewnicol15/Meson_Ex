...
void Tree_Reader_New_Skim3(){

  gROOT->ProcessLine(".L ./Loader.C+");
  TFile *f = new TFile("Trees/skim4_Pass1_Tree_020620_01.root");
  TTree *t1 = (TTree*)f->Get("Skim4_Tree_020620_01");
  ...
  TFile fileOutput1("New_Data/Skim3_Pass1_Analysis_030620_01.root","recreate");
  ...
  //PID only cut
  auto* hmiss_mass_all=new TH1F("miss_all","MM^2(e' K^{+} p #pi^{-});MM^2(e' K^{+} p #pi^{-}) [GeV];Counts",400,-1,4);
  auto* hmiss_momentum_all=new TH1F("hmiss_momentum_all","P(B + T - e' - K^{+} - p - #pi^{-});P(B + T - e' - K^{+} - p - #pi^{-}) [GeV];Counts",400,-1,4);
  auto* hmiss_mass_all_casc=new TH1F("hmiss_mass_all_casc","MM^2(e' K^{+} K^{+} p #pi^{-} #pi^{-});MM^2(e' K^{+} K^{+} p #pi^{-} #pi^{-}) [GeV];Counts",400,-1,4);
  auto* hmiss_momentum_all_casc=new TH1F("hmiss_momentum_all_casc","P(B + T - e' - K^{+} - K^{+} - p - #pi^{-});P(B + T - e' - K^{+} - K^{+} - p - #pi^{-}) [GeV];Counts",400,-1,4);
  auto* hmiss_1=new TH1F("miss_1","MM(e' K^{+});MM(e' K^{+}) [GeV];Counts",500,-1,4);
  auto* hmiss_2=new TH1F("miss_2","MM^2(e' K^{+} p);MM^2(e' K^{+} p) [GeV];Counts",400,-0.5,0.5);
  auto* hmiss_3=new TH1F("hmiss_3","MM(e' K^{+} K^{+});MM(e' K^{+} K^{+}) [GeV];Counts",500,-1,4);
  auto* hmiss_4=new TH1F("miss_4","MM^2(e' K^{+} K^{+} p);MM^2(e' K^{+} K^{+} p) [GeV];Counts",400,-0.5,0.5);
  ...
  auto* hcascade=new TH2D("cascade","M(p #pi^{-} (1)) against M(p #pi^{-} (2));M(p #pi^{-}) [GeV];Counts",200,0.5,2.5,200,0.5,2.5);
  auto* hcascade_lambda_1=new TH1F("cascade_lambda_1","M(p #pi^{-} (1));M(p #pi^{-}) [GeV];Counts",200,0.5,2.5);
  auto* hcascade_lambda_2=new TH1F("cascade_lambda_2","M(p #pi^{-} (2));M(p #pi^{-}) [GeV];Counts",200,0.5,2.5);
  auto* hmiss_inv_cascade_1=new TH2D("miss_inv_cascade_1","M(p #pi^{-} #pi^{-}) against MM(e' K^{+} K^{+});M(p #pi^{-} #pi^{-}) [GeV];MM(e' K^{+} K^{+}) [GeV]",200,0.5,2.5,200,0.5,2.5);
  auto* hkaon1_beta=new TH2D("hkaon1_beta","#Delta#Beta K^{+} (1));P [GeV];#Delta#Beta K^{+} (1)",200,0,11,100,-0.2,0.2);
  auto* hkaon2_beta=new TH2D("hkaon2_beta","#Delta#Beta K^{+} (2));P [GeV],#Delta#Beta K^{+} (2)",200,0,11,100,-0.2,0.2);
  ...
  auto* hvertex_time_kp2=new TH2D("hvertex_time_kp2","Vertex time K^{+} (1) against Vertex time K^{+} (2);Vertex time K^{+} (1);Vertex time K^{+} (2)",200,-100,100,200,-100,100);
  auto* hdelta_vertex_time_kp2=new TH1F("hdelta_vertex_time_kp2","#Delta Vertex time K^{+};#Delta Vertex time K^{+};Counts",500,-500,500);
  auto* hdocappi=new TH1F("hdocappi","DOCA for p and #pi^{-};DOCA [cm];Counts",250,0,5);
  auto* hdocaeK=new TH1F("hdocaeK","DOCA for e' and K^{+};DOCA [cm];Counts",250,0,5);
  auto* hdelta_phi_S1_pr_pim=new TH1F("hdelta_phi_S1_pr_pim","#Delta #Phi between p and #pi^{-};#Delta #Phi (p pi^{-});Counts",361,0,360);
  ...
  auto* hmiss_mass_all_cascc=new TH1F("hmiss_mass_all_cascc","MM^2(e' K^{+} K^{+} p #pi^{-} #pi^{-});MM^2(e' K^{+} K^{+} p #pi^{-} #pi^{-}) [GeV];Counts",400,-1,4);
  auto* hmiss_momentum_all_cascc=new TH1F("hmiss_momentum_all_cascc","P(B + T - e' - K^{+} - K^{+} - p - #pi^{-}) after cuts on delta beta and momentum of K^{+} and p;P(B + T - e' - K^{+} - K^{+} - p - #pi^{-}) [GeV];Counts",400,-1,4);
  auto* hmiss_1c=new TH1F("miss_1c","MM(e' K^{+}) after cuts on delta beta and momentum of K^{+} and p;MM(e' K^{+}) [GeV];Counts",500,-1,4);
  auto* hmiss_2c=new TH1F("miss_2c","MM^2(e' K^{+} p) after cuts on delta beta and momentum of K^{+} and p;MM^2(e' K^{+} p) [GeV];Counts",400,-0.5,0.5);
  auto* hmiss_3c=new TH1F("miss_3c","MM(e' K^{+} K^{+}) after cuts on delta beta and momentum of K^{+} and p;MM(e' K^{+} p) [GeV];Counts",500,-1,4);
  auto* hmiss_4c=new TH1F("miss_4c","MM^2(e' K^{+} K^{+} p) after cuts on delta beta and momentum of K^{+} and p;MM^2(e' K^{+} p) [GeV];Counts",400,-0.5,0.5);
  auto* hmiss_5c=new TH1F("hmiss_5c","MM(e' K^{+} K^{+} K^{+}) after cuts on delta beta and momentum of K^{+};MM(e' K^{+} K^{+} K^{+}) [GeV];Counts",600,-3,3);
  auto* hlambda_1c=new TH1F("lambda_1c","M(p #pi^{-}) after cuts on delta beta and momentum of K^{+} and p;M(p #pi^{-}) [GeV];Counts",750,0.5,2.0);
  auto* hcascade_c=new TH2D("cascade_c","M(p #pi^{-} (1)) against M(p #pi^{-} (2)) after cuts on delta beta and momentum of K^{+} and p;M(p #pi^{-}) [GeV];Counts",200,0.5,2.5,200,0.5,2.5);
  auto* hcascade_lambda_1c=new TH1F("cascade_1c","M(p #pi^{-} (1)) after cuts on delta beta and momentum of K^{+} and p;M(p #pi^{-}) [GeV];Counts",200,0.5,2.5);
  auto* hcascade_lambda_2c=new TH1F("cascade_2c","M(p #pi^{-} (2)) after cuts on delta beta and momentum of K^{+} and p;M(p #pi^{-}) [GeV];Counts",200,0.5,2.5);
  auto* hmiss_inv_cascade_1c=new TH2D("miss_inv_cascade_1c","M(p #pi^{-}) against MM(e' K^{+} K^{+}) after cuts on delta beta and momentum of K^{+} and p;M(p #pi^{-}) [GeV];MM(e' K^{+} K^{+}) [GeV]",200,0.5,2.5,200,0.5,2.5);
  ...
  auto* hmiss_1t=new TH1F("miss_1t","MM(e' K^{+}) after cuts on delta beta and momentum of K^{+} and p and MM^2(e' K^{+} p) cut;MM(e' K^{+}) [GeV];Counts",500,-1,4);
  auto* hmiss_2t=new TH1F("miss_2t","MM^2(e' K^{+} p) after cuts on delta beta and momentum of K^{+} and p and MM^2(e' K^{+} p) cut;MM^2(e' K^{+} p) [GeV];Counts",400,-0.5,0.5);
  auto* hmiss_3t=new TH1F("miss_3t","MM(e' K^{+} K^{+}) after cuts on delta beta and momentum of K^{+} and p and MM(e' K^{+} p) cut;MM^2(e' K^{+} p) [GeV];Counts",500,-1,4);
  auto* hmiss_4t=new TH1F("miss_4t","MM^2(e' K^{+} K^{+} p) after cuts on delta beta and momentum of K^{+} and p and MM^2(e' K^{+} p) cut;MM^2(e' K^{+} p) [GeV];Counts",400,-0.5,0.5);
  ...
  auto* hcascade_t=new TH2D("hcascade_t","M(p #pi^{-} (1)) against M(p #pi^{-} (2)) after cuts on delta beta and momentum of K^{+} and p and MM^2(e' K^{+} p) cut;M(p #pi^{-}) [GeV];Counts",200,0.5,2.5,200,0.5,2.5);
  auto* hcascade_lambda_1t=new TH1F("cascade_1t","M(p #pi^{-} (1)) after cuts on delta beta and momentum of K^{+} and p and MM^2(e' K^{+} p) cut;M(p #pi^{-}) [GeV];Counts",200,0.5,2.5);
  auto* hcascade_lambda_2t=new TH1F("cascade_2t","M(p #pi^{-} (2)) after cuts on delta beta and momentum of K^{+} and p and MM^2(e' K^{+} p) cut;M(p #pi^{-}) [GeV];Counts",200,0.5,2.5);
  ...
  TLorentzVector cascade_lambda_1;
  TLorentzVector cascade_lambda_2;
  ...
  for(Long64_t i=0; i<nentries;i++){
    ...
    if(v_kp.size()==1 && v_el.size()==1 && v_pr.size()==1 && v_pim.size()==1){
      ...
      missall = (TLorentzVector)*readbeam + (TLorentzVector)*readtarget - el_corrected - v_kp.at(0) - v_pr.at(0) - v_pim.at(0);
      miss1 = (TLorentzVector)*readbeam + (TLorentzVector)*readtarget - el_corrected - v_kp.at(0);
      miss2 = (TLorentzVector)*readbeam + (TLorentzVector)*readtarget - el_corrected - v_kp.at(0) - v_pr.at(0);
      lambda = v_pr.at(0) + v_pim.at(0);

      delta_phi_S1_pr_pim = v_pr.at(0).Angle(v_pim.at(0).Vect());


      hdelta_phi_S1_pr_pim->Fill(delta_phi_S1_pr_pim);
    ...
    if(v_kp.size()==3 && v_el.size()==1){
      miss5 = (TLorentzVector)*readbeam + (TLorentzVector)*readtarget - el_corrected - v_kp.at(0) - v_kp.at(1) - v_kp.at(2);
